$(document).ready(function () {
    do {
        ...
        //Alerta para x-user
        var xuser = prompt("Por favor, inserta tu x-user");
        //Alerta para dinero inicial
        var abonoinicial = prompt("Por favor, inserta el dinero inicial de tu liga");
    }
    while (token == '' || xleague == '' || abonoinicial == '' || xuser == '');
    $.when(
        //Llamada API para obtener las ventas de los jugadores
        $.ajax({
            url: 'https://cors-anywhere.herokuapp.com/https://biwenger.as.com/api/v2/league/'+xleague+'/board?type=transfer&limit=200',
            headers: {
        ...
        $.ajax({
            url: 'https://cors-anywhere.herokuapp.com/https://biwenger.as.com/api/v2/league/'+xleague+'/board?type=market&limit=200',
            headers: {
                'Authorization': 'Bearer ' + token,
                'x-league': xleague,
                'x-user': xuser,
        ...
        $.ajax({
            url: 'https://cors-anywhere.herokuapp.com/https://biwenger.as.com/api/v2/league/'+xleague+'/board?type=roundFinished&limit=38',
            headers: {
                'Authorization': 'Bearer ' + token,
                'x-league': xleague,
                'x-user': xuser,
        ...
        $.ajax({
            url: 'https://cors-anywhere.herokuapp.com/https://biwenger.as.com/api/v2/league/'+xleague+'/board?type=bonus&limit=200',
            headers: {
                'Authorization': 'Bearer ' + token,
                'x-league': xleague,
                'x-user': xuser,
